...
async function getUsers(){
    const response = await fetch("http://www.mpp.erikpineiro.se/dbp/sameTaste/users.php");
...
function getPaintings(storedPics, userId, mainUserFavorite){
    ...
    if(storedPics){
        ...
        storedPics.sort((a,b) => a.artistDisplayName > b.artistDisplayName);

        storedPics.forEach(obj => {
        ...
        paintings.sort((a,b) => a.artistDisplayName > b.artistDisplayName);
